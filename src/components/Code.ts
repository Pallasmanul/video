...
export const CppCode = withDefaults(Code, {
  highlighter: new LezerHighlighter(cpp, Style),
  ...Defaults,
});

export const MarkdownCode = withDefaults(Code, {
  highlighter: new LezerHighlighter(markdown, Style),
  ...Defaults,
});

export const JsonCode = withDefaults(Code, {
    highlighter: new LezerHighlighter(json, Style),
    ...Defaults,
});

export const XmlCode = withDefaults(Code, {
  highlighter: new LezerHighlighter(xml, Style),
  ...Defaults,
});
